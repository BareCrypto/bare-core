...
In order to support loading of multiple wallets in bare-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bare.cpp.
