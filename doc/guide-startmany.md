...
If you are using a masternode.conf file you no longer need the bare.conf file. The exception is if you need custom settings (thanks oblox). 

## Update bare.conf on server

If you generated a new masternode private key, you will need to update the remote bare.conf files.
