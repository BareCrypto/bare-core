...
*Setup instructions for a gitian build of Bare using a Debian VM or physical system.*
...
Clone the git repositories for Bare and gitian and then checkout the Bare version that you want to build.

```bash
git clone https://github.com/devrandom/gitian-builder.git
git clone https://github.com/BareCrypto/bare-core/bare-core.git
cd bare-core
...
Follow the instructions in [doc/release-process.md](release-process.md) in the bare-core repository
...
To build Bare (for Linux, OSX, and Windows) just follow the steps under 'perform
gitian builds' in [doc/release-process.md](release-process.md) in the bare-core repository.
...
```bash
    Initialized empty Git repository in /home/debian/gitian-builder/inputs/bare-core/.git/
    remote: Reusing existing pack: 35606, done.
    remote: Total 35606 (delta 0), reused 0 (delta 0)
    Receiving objects: 100% (35606/35606), 26.52 MiB | 4.28 MiB/s, done.
    Resolving deltas: 100% (25724/25724), done.
    From https://github.com/BareCrypto/bare-core/bare-core
...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/bare-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/bare-build.assert
    gpg --detach-sign ${VERSION}-osx/${SIGNER}/bare-build.assert
```
