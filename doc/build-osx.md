...
4. Enter "bare-qt" as project name, enter src/qt as location
...
Once dependencies are compiled, see release-process.md for how the Bare-Qt.app
bundle is packaged and signed to create the .dmg disk image that is distributed.

Running
-------

It's now available at `./bared`, provided that you are still in the `src`
directory. We have to first create the RPC configuration file, though.

Run `./bared` to get the filename where it should be put, or just try these
commands:

    echo -e "rpcuser=barerpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/Bare/bare.conf"
    chmod 600 "/Users/${USER}/Library/Application Support/Bare/bare.conf"
