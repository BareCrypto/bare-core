...
If you want to build Bare-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a bare-qt executable will be
built by default.
