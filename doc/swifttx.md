...
This mechanism has been integrated into Bitcore-Node-Bare which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/crypto-node/insight-api-bare#web-socket-api](https://github.com/crypto-node/insight-api-bare#web-socket-api) 
* API: [https://github.com/crypto-node/insight-api-bare#swifttx-transactions](https://github.com/crypto-node/insight-api-bare#swifttx-transactions) 
...
By default, the Bare Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Bare Core daemon:
