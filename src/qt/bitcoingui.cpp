                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    labelBAREIcon = new QLabel();
    //labelBAREIcon->setObjectName("XmxIcon");
    //labelBAREIcon->setStyleSheet("QLabel {font-family: Segoe UI, Tahoe, Georgia, sans-serif, font-weight: 900; font-size: 14px; color: #606060; }");
    labelBAREIcon->setPixmap(QIcon(":/icons/label_xmx").pixmap(37, 11));
    frameBlocksLayout->addStretch();
    frameBlocksLayout->addWidget(labelBAREIcon);
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bare address"));
...
*/
    ...
    aboutAction = new QAction(QIcon(":/icons/info_menu"), tr("&About Bare Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bare Core"));
    aboutAction->setMenuRole(QAction::AboutRole);
#if QT_VERSION < 0x050000
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bare"));
    ...
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bare addresses"));
    ...
    openAction->setStatusTip(tr("Open a BARE:URI or payment request"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Bare Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bare network", "", count));
}
...
{
    QString strTitle = tr("Bare"); // default title
