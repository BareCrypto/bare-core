...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    showExplorerAction = new QAction(QIcon(":/icons/blockexplorer"), tr("BARE Explorer"), this);
	showCrexAction = new QAction(QIcon(":/icons/crex24"), tr("Crex 24 Market BARE/BTC"), this);
	showCoingeckoAction = new QAction(QIcon(":/icons/CoinGecko"), tr("CoinGecko BARE"), this);
...
{
    QString strTitle = tr("Bare Core"); // default title
