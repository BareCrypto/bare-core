...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"bare", "masternodelist", &masternodelist, true, true, false},
        {"bare", "mnbudget", &mnbudget, true, true, false},
        {"bare", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"bare", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bare", "mnsync", &mnsync, true, true, false},
        {"bare", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"bare", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bared, or the -server option to bare-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
