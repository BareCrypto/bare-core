...
UniValue getrawmempool(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "    \"fee\" : n,              (numeric) transaction fee in bare\n"
...
UniValue getblock(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 1 || params.size() > 2)
        throw runtime_error(
            ...
            "  \"zBAREsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zBARE denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zBARE denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zBARE denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zBARE denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zBARE denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zBARE denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zBARE denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zBARE denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zBARE denominations\n"
            "  }\n"
            "}\n"
            "\nResult (for verbose=false):\n"
...
UniValue gettxout(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 3)
        throw runtime_error(
            ...
            "  \"value\" : x.xxx,           (numeric) The transaction value in bare\n"
            "  \"scriptPubKey\" : {         (json object)\n"
            "     \"asm\" : \"code\",       (string) \n"
            "     \"hex\" : \"hex\",        (string) \n"
            "     \"reqSigs\" : n,          (numeric) Number of required signatures\n"
            "     \"type\" : \"pubkeyhash\", (string) The type, e.g. pubkeyhash\n"
            "     \"addresses\" : [          (array of string) array of bare addresses\n"
            "     \"bareaddress\"   	 	(string) bare address\n"
            "        ,...\n"
            "     ]\n"
            "  },\n"
