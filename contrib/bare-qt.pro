...
RESOURCES += src/qt/bare.qrc src/qt/bare_locale.qrc

TRANSLATIONS += src/qt/locale/bare_bg.ts \
                src/qt/locale/bare_de.ts \
                src/qt/locale/bare_en.ts \
                src/qt/locale/bare_es.ts \
                src/qt/locale/bare_fi.ts \
                src/qt/locale/bare_fr.ts \
                src/qt/locale/bare_it.ts \
                src/qt/locale/bare_ja.ts \
                src/qt/locale/bare_pl.ts \
                src/qt/locale/bare_pt.ts \
                src/qt/locale/bare_ru.ts \
                src/qt/locale/bare_sk.ts \
                src/qt/locale/bare_sv.ts \
                src/qt/locale/bare_vi.ts \
                src/qt/locale/bare_zh_CN.ts \
                src/qt/locale/bare_zh_TW.ts
